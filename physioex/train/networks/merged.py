...
class SectionReconstructor(nn.Module):
    def __init__(self,
        ...
        self.precalculated_bias = torch.tensor([4.69935885e-02, 2.72655852e-01, 3.59248330e-01, 2.88467862e-01,
            2.02679654e-01, 1.48740995e-01, 1.18811582e-01, 9.91408686e-02,
            8.26801009e-02, 6.78855180e-02, 5.63883343e-02, 4.67726515e-02,
            4.07304234e-02, 3.58516116e-02, 3.05045653e-02, 2.71619588e-02,
            2.46401190e-02, 2.27789786e-02, 2.18954963e-02, 2.03740188e-02,
            1.90843127e-02, 1.75774116e-02, 1.60305662e-02, 1.48765488e-02,
            1.33400526e-02, 1.22482657e-02, 1.13273480e-02, 1.04249065e-02,
            9.86872116e-03, 9.09727043e-03, 8.56627996e-03, 8.24966009e-03,
            7.85724278e-03, 7.69834969e-03, 7.29884718e-03, 6.60969567e-03,
            5.78876980e-03, 4.90143182e-03, 4.28611048e-03, 3.75885540e-03,
            3.39048350e-03, 3.25430324e-03, 2.92378605e-03, 2.75682649e-03,
            2.66402496e-03, 2.54116895e-03, 2.43178161e-03, 2.28417229e-03,
            2.21713255e-03, 2.15788339e-03, 2.06495032e-03, 2.01071901e-03,
            1.94201644e-03, 1.89269842e-03, 1.84227713e-03, 1.76307820e-03,
            1.70303227e-03, 1.63558224e-03, 1.58556306e-03, 1.55762188e-03,
            1.49985485e-03, 1.46006694e-03, 1.41589390e-03, 1.37845989e-03,
            1.35386780e-03, 1.29776264e-03, 1.26317732e-03, 1.23753294e-03,
            1.20005303e-03, 1.17899155e-03, 1.13895196e-03, 1.10998192e-03,
            1.08401747e-03, 1.04549794e-03, 1.03225105e-03, 1.03059671e-03,
            1.03701619e-03, 9.98829400e-04, 9.56272925e-04, 9.31914671e-04,
            9.01429851e-04, 8.84140267e-04, 8.76553948e-04, 8.53372512e-04,
            8.40003741e-04, 8.26225905e-04, 8.11609763e-04, 8.00230725e-04,
            7.81856266e-04, 7.67980212e-04, 7.47503034e-04, 7.20413550e-04,
            6.91140489e-04, 6.50238391e-04, 6.02897014e-04, 5.44551526e-04,
            4.66722128e-04, 3.82089075e-04, 2.95800965e-04, 2.16208898e-04],
            device="cuda", dtype=torch.float32)

        assert self.precalculated_bias.size() == self.amplitude_layer[-1].bias.size(), "Bias size must be equal to the precalculated bias size"
        with torch.no_grad():
            print("Initializing bias with precalculated values")
            self.amplitude_layer[-1].bias.copy_(self.precalculated_bias)
            self.amplitude_layer[-1].bias.requires_grad = False
